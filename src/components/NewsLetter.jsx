...
function SampleNextArrow(props) {
  ...
  return (
    <div
      onClick={onClick}
      className="next h-[52px] w-[52px] cursor-pointer rounded-full bg-white flex items-center text-[#A5A5A5] justify-center absolute top-[80px] right-[100px]"
    >
      <ArrowRight />
    </div>
  );
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      onClick={onClick}
      className="pre h-[52px] w-[52px] cursor-pointer absolute top-[80px] right-[172px] z-50 rounded-full text-[#A5A5A5] bg-white flex items-center justify-center"
    >
      <ArrowLeft />
    </div>
  );
